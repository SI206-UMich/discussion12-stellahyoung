...
def problematic_salary(cur, conn):
    cur.execute("SELECT Employee.first_name, Employee.last_name FROM Employee JOIN Jobs \
    ON Employee.job_id=Jobs.job_id WHERE Employee.salary > Jobs.min_salary \
    AND Employee.salary < Jobs.max_salary")
    res = cur.fetchall()
    return res
